        ...
        <div className="park-container">
            <div class="container_">
                ...
                <div class="text-container">
                    <h1>Bandhavgarh National Park</h1>
                    <p>
                        Bandhavgarh National Park in Madhya Pradesh, India, is renowned for its 
                        high density of Bengal tigers and a diverse range of wildlife, including 
                        leopards, sloth bears, and various deer species. The park's landscape, 
                        featuring dense forests, grasslands, and ancient ruins, offers a captivating 
                        setting for wildlife viewing. Expert-guided safaris provide immersive experiences, 
                        enhancing the chances of unforgettable wildlife encounters. Visitors can choose 
                        from luxury resorts to cozy campsites, ensuring a comfortable stay amidst nature. 
                        Bandhavgarh is perfect for photography, bird watching, and eco-tourism, making it 
                        an ideal destination for nature enthusiasts seeking the natural splendor and wildlife 
                        of central India.
                    </p>
                    <div class="info">
                        <span><i class='fas fa-map-marker-alt'></i> Bandhavgarh National Park </span>
...
export default BandhavgarhPark;