        ...
        <div className="park-container">
            <div class="container_">
                <div class="image-container">
                    <img src="../t_park.webp" alt="Tigers in Tadoba National Park"/>
                </div>
                <div class="text-container">
                    <h1>Tadoba National Park</h1>
                    <p>
                        Tadoba National Park, located in Maharashtra, India, is a 
                        top destination for wildlife enthusiasts and safari lovers. 
                        Known for its impressive population of Bengal tigers, the 
                        park also hosts leopards, sloth bears, Indian bison (gaur), 
                        and a variety of bird species. The park's diverse landscapes, 
                        including dense forests and expansive grasslands, provide 
                        the perfect backdrop for thrilling safaris led by expert 
                        naturalist guides. These safaris offer valuable insights into 
                        Tadoba’s rich biodiversity and promise unforgettable wildlife 
                        sightings. Visitors can choose from a range of accommodation 
                        options, from comfortable lodges to rustic campsites, making 
                        it an ideal base for exploring this vibrant sanctuary. Tadoba 
                        National Park is a must-visit for nature lovers, adventure 
                        seekers, and photographers, offering abundant opportunities 
                        for eco-tourism and capturing the wild beauty of India.
                    </p>
                    <div class="info">
                        <span><i class='fas fa-map-marker-alt'></i> Tadoba National Park </span>
            ...
            <div id="Highlits_">
                <div class="about-details">
                    <div class="highlight-img">
                        <img src="https://strapi.wildexcursions.in/uploads/bengal_tiger_in_tadoba_indian_jungle_b878271874.webp" alt="" />
                    </div>
