        ...
        <div className="park-container">
            <div class="container_">
                ...
                <div class="text-container">
                    ...
                    <p>
                        Pench National Park in Madhya Pradesh, India, is a captivating haven for wildlife 
                        enthusiasts and nature lovers. Renowned for its Bengal tigers and leopards, the 
                        park is also home to deer, wild boars, and numerous bird species. The landscape, 
                        characterized by teak forests, grasslands, and the picturesque Pench River, adds 
                        to its scenic beauty. Guided safaris, led by expert naturalists, offer visitors 
                        the chance to explore diverse ecosystems and observe wildlife up close. Accommodation 
                        options range from luxurious resorts to eco-friendly campsites, providing a comfortable 
                        retreat for adventurers. Pench National Park promises an unforgettable wildlife 
                        experience, with excellent opportunities for photography, bird watching, and eco-tourism, 
                        making it an ideal getaway for those seeking to immerse themselves in central India's 
                        natural splendor.
                    </p>
                    <div class="info">
